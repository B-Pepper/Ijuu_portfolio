...
{
    /// <summary>
    /// ダイナマイトを設置するギミックのModel
    /// </summary>
    public class BedRoomDynamiteGimmickModel : BaseGimmickModel
    {
        /// <summary>
        /// ギミック番号
        /// </summary>
        private int _gimmickId = 7;
        ...
        {
            _gimmickId = GimmickConstant.GIMMICK_BEDROOM_DYNAMITE_ID;

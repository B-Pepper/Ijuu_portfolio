...
namespace MVP.Models
{
    ...
    /// 台所のレコードのModel
    /// </summary>
    public class DiningRecordGimmickModel : BaseGimmickModel
    {
        /// <summary>
        /// ギミック番号
        /// </summary>
        private int _gimmickId = 10;

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DiningRecordGimmickModel()
        {
        ...
        {
            _gimmickId = GimmickConstant.GIMMICK_DINING_RECORD_ID;
        ...
        {
            Config.SetItemStatus(gimmickId, status);
        }
    }
}
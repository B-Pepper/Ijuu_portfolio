...
{
    /// <summary>
    /// ダイナマイトが着火されるギミックのModel
    /// </summary>
    public class IgnitionDynamiteGimmickModel : BaseGimmickModel
    {
        /// <summary>
        /// ギミック番号
        /// </summary>
        private int _gimmickId = 14;

        /// <summary>
        /// コンストラクタ
        /// </summary>
        public IgnitionDynamiteGimmickModel()
        {
            InitGimmickInfo();
        }
        ...
        {
            _gimmickId = GimmickConstant.GIMMICK_BEDROOM_IGNITION_ID;

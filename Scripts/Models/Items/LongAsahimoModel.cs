...
namespace MVP.Models
{
    ...
    /// 麻紐(長)のModel
    /// </summary>
    public class LongAsahimoModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 15;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_KEYINICE_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_LONGASAHIMO_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_LONGASAHIMO_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_LONGASAHIMO_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_LONGASAHIMO_IMAGENAME);

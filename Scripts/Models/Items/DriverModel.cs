...
namespace MVP.Models
{
    ...
    /// ドライバーのModel
    /// </summary>
    public class DriverModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 6;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_DRIVER_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_DRIVER_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_DRIVER_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_DRIVER_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_DRIVER_IMAGENAME);

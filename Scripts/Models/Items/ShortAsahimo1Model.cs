...
namespace MVP.Models
{
    ...
    /// 麻紐(短)のModel
    /// </summary>
    public class ShortAsahimo1Model : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_ASAHIMO1_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_ASAHIMO1_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_ASAHIMO1_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_ASAHIMO1_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_ASAHIMO1_IMAGENAME);

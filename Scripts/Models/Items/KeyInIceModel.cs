...
namespace MVP.Models
{
    ...
    /// 解凍した鍵のModel
    /// </summary>
    public class KeyInIceModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 9;
        ...
        {
            _itemId = ItemConstant.ITEM_KEYINICE_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_KEYINICE_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_KEYINICE_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_KEYINICE_IMAGENAME);

...
namespace MVP.Models
{
    ...
    /// 玄関の謎のModel
    /// </summary>
    public class MysteryOfTheEntranceModel : BaseItemModel
    {
            /// <summary>
            /// アイテムID
            /// </summary>
            private int _itemId = 13;
            ...
            {
                _itemId = ItemConstant.ITEM_MYSTERYPAPERENTRANCE_ID;
                Config.SetItemName(_itemId, ItemConstant.ITEM_MYSTERYPAPERENTRANCE_NAME);
                Config.SetItemExplain(_itemId, ItemConstant.ITEM_MYSTERYPAPERENTRANCE_EXPLAIN);
                Config.SetItemImageName(_itemId, ItemConstant.ITEM_MYSTERYPAPERENTRANCE_IMAGENAME);

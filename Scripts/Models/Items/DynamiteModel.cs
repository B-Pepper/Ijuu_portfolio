...
namespace MVP.Models
{
    ...
    /// ダイナマイトのModel
    /// </summary>
    public class DynamiteModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 11;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_DYNAMITE_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_DYNAMITE_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_DYNAMITE_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_DYNAMITE_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_DYNAMITE_IMAGENAME);

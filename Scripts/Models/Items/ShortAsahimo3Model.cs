...
namespace MVP.Models
{
    ...
    /// 麻紐(短)のModel
    /// </summary>
    public class ShortAsahimo3Model : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 3;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_ASAHIMO3_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_ASAHIMO3_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_ASAHIMO3_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_ASAHIMO3_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_ASAHIMO3_IMAGENAME);

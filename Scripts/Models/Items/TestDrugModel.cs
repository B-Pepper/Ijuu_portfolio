...
namespace MVP.Models
{
    ...
    /// 治療薬のModel
    /// </summary>
    public class TestDrugModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 14;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_TESTDRUG_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_TESTDRUG_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_TESTDRUG_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_TESTDRUG_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_TESTDRUG_IMAGENAME);

...
namespace MVP.Models
{
    ...
    /// 氷塊のModel
    /// </summary>
    public class IceBlockModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 8;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_ICEBLOCK_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_ICEBLOCK_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_ICEBLOCK_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_ICEBLOCK_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_ICEBLOCK_IMAGENAME);

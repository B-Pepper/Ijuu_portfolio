...
namespace MVP.Models
{
    ...
    /// ビニールテープのModel
    /// </summary>
    public class TapeModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 5;
        ...
        /// アイテム画像名
        /// </summary>
        private string _itemImageName = ItemConstant.ITEM_TAPE_IMAGENAME;
        ...
        {
            _itemId = ItemConstant.ITEM_TAPE_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_TAPE_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_TAPE_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_TAPE_IMAGENAME);

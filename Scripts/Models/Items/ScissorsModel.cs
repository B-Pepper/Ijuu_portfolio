...
namespace MVP.Models
{
    ...
    /// ハサミのModel
    /// </summary>
    public class ScissorsModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        ...
        {
            _itemId = ItemConstant.ITEM_SCISSORS_ID;
            Config.SetItemName(_itemId, ItemConstant.ITEM_SCISSORS_NAME);
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_SCISSORS_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_SCISSORS_IMAGENAME);

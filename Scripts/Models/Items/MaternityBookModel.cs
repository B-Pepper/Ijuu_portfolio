...
namespace MVP.Models
{
    ...
    /// 母子手帳のModel
    /// </summary> 
    public class MaternityBookModel : BaseItemModel
    {
        /// <summary>
        /// アイテムID
        /// </summary>
        private int _itemId = 18;
        ...
        public override void InitItemInfo()
        {
            ...
            Config.SetItemExplain(_itemId, ItemConstant.ITEM_MYSTERYPAPER_EXPLAIN);
            Config.SetItemImageName(_itemId, ItemConstant.ITEM_MYSTERYPAPER_IMAGENAME);
